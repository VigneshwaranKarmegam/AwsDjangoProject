...
# Run application
CMD ["gunicorn", "--workers", "1", "--bind", "0.0.0.0:8000", "--timeout", "90", "--access-logfile", "/home/app/web/access.log", "--error-logfile", "/home/app/web/error.log", "myproject.wsgi:application"]
